...
$mpbp_service_listing = new mpbp_data_listing();
  ...
  $mpbp_service_listing->mpbp_listing_button_url = '/wp-admin/admin.php?page=users';
  $mpbp_service_listing->mpbp_items = 'Users';
  $mpbp_service_listing->mpbp_page_name = 'all_users';
  $mpbp_service_listing->mpbp_listing_url = '/wp-admin/admin.php?page=all_users&order=';
